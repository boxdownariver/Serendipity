...
serendipity: src/mainmenu.cpp out/cashier.o out/menuDriver.o out/invmenu.o out/reports.o out/lookUp.o out/bookfile.o out/addbook.o out/bookInfo.o out/editbook.o out/deleteBook.o out/setColour.o out/  
	g++ --std=c++20 -o "serendipity" src/mainmenu.cpp out/menuDriver.o out/invmenu.o out/lookUp.o out/reports.o out/cashier.o out/bookfile.o out/addbook.o out/bookInfo.o out/editbook.o out/deleteBook.o out/setColour.o -lncurses -lmenu -lform
